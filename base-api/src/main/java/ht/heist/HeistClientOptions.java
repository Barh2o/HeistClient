...
import ht.heist.util.AudioDeviceChecker;
import ht.heist.util.optionsparser.OptionsParser;
import ht.heist.util.optionsparser.annotations.CLIArgument;
import lombok.Getter;

@Getter
public class HeistClientOptions extends OptionsParser
{
    @CLIArgument(
            name = "rsdump",
    ...
    @CLIArgument(
            name = "incognito",
            description = "[Optional] Visually display as 'RuneLite' instead of 'HeistClient'"
    )
