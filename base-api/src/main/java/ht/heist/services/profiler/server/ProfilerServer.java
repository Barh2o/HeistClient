package ht.heist.services.profiler.server;

import com.sun.net.httpserver.HttpExchange;
import com.sun.net.httpserver.HttpServer;
import ht.heist.services.profiler.MetricSnapshot;
import ht.heist.services.profiler.ResourceMetricsCollector;
import ht.heist.services.profiler.recording.JFRMethodRecorder;
import ht.heist.services.profiler.recording.MethodProfiler;
import ht.heist.services.profiler.recording.MethodStats;
import ht.heist.services.profiler.recording.MethodTimingResults;
import ht.heist.services.profiler.recording.CallTreeNode;
import ht.heist.services.profiler.sampling.CPUSampler;
import ht.heist.services.profiler.sampling.MemorySampler;
import ht.heist.services.profiler.sampling.StackSample;
import ht.heist.services.profiler.sampling.HeapHistogramSample;
import ht.heist.services.profiler.sampling.SampleAnalyzer;
...
public class ProfilerServer {
    ...
    private void handleRoot(HttpExchange exchange) throws IOException {
        ...
        if (path.equals("/") || path.equals("/profiler") || path.equals("/profiler/")) {
            ...
            json.append("{\n");
            json.append("  \"name\": \"HeistClient Profiler API\",\n");
