...
public class TrajectorySettingsPanel extends VitaFrame
{
    ...
    private void openDocumentation()
    {
        try
        {
            Desktop.getDesktop().browse(new java.net.URI("https://github.ht/heist-Box/HeistClient/blob/main/docs/MOUSE-MOVEMENT.md"));
        }
        catch (Exception ex)
        {
            JOptionPane.showMessageDialog(this,
                "Could not open documentation in browser.\nURL: https://github.ht/heist-Box/HeistClient/blob/main/docs/MOUSE-MOVEMENT.md",
                "Error",
