...
import ht.heist.model.RuneLite;
import ht.heist.util.ClientConfig;
...
public class Static
{
    ...
    public static final Path VITA_DIR = Path.of(RUNELITE_DIR.toString(), "HeistClient");
    @Getter
    ...
    @Getter
    private static final HeistClientOptions cliArgs = new HeistClientOptions();
