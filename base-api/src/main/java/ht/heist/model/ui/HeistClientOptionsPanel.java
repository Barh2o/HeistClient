package ht.heist.model.ui;

import ht.heist.Logger;
import ht.heist.Static;
import ht.heist.events.PacketReceived;
import ht.heist.events.PacketSent;
import ht.heist.model.ui.components.*;
import ht.heist.services.ClickManager;
import ht.heist.services.ClickStrategy;
import ht.heist.services.mouserecorder.DecodedMousePacket;
import ht.heist.services.mouserecorder.MousePacketDecoder;
import ht.heist.services.mouserecorder.trajectory.TrajectoryService;
import ht.heist.services.mouserecorder.trajectory.ui.TrajectoryTrainerMonitor;
import ht.heist.services.mouserecorder.trajectory.ui.TrajectorySettingsPanel;
import ht.heist.services.pathfinder.PathfinderAlgo;
import ht.heist.services.mouserecorder.MovementVisualization;
import ht.heist.services.profiler.ProfilerWindow;
import ht.heist.util.ReflectBuilder;
import ht.heist.util.ThreadPool;
import javax.swing.*;
import java.awt.*;

public class HeistClientOptionsPanel extends VPluginPanel {

    private static HeistClientOptionsPanel INSTANCE;

    public static HeistClientOptionsPanel getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new HeistClientOptionsPanel();
        }
        return INSTANCE;
    }
    ...
    private HeistClientOptionsPanel() {
        super(false);
