...
public class MethodHookTransformer {
     ...
     * @param method the method node annotated with {@link MethodHook} to be used as
     *               a hook
    ...
    public static void patch(ClassNode mixin, MethodNode method) {
        ...
        if (gamepack == null) {
            System.out.println("[MethodHookTransformer] WARN: No method mapping for " + name + " — skipping.");
            return;
        }
