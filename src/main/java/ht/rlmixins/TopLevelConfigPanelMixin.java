...
public class TopLevelConfigPanelMixin {
        @Insert(method = "<init>", at = @At(value = AtTarget.INVOKE, owner = "net/runelite/client/plugins/config/TopLevelConfigPanel", target = "addTab"), ordinal = -1, raw = true)
