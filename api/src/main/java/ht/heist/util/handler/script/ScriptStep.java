...
import ht.heist.util.handler.StepContext;
...
public interface ScriptStep {
    ...
    class IncludeHandlerStep implements ScriptStep {
        private final ht.heist.util.handler.StepHandler handler;

        public IncludeHandlerStep(ht.heist.util.handler.StepHandler handler) {
