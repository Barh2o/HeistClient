package ht.heist.services.pathfinder.tiletype;

import ht.heist.data.wrappers.PlayerEx;
import ht.heist.services.pathfinder.Walker;
import ht.heist.services.pathfinder.collision.SparseBitSet;
...
public class TileTypeMap {
     ...
     * Reconstructs the 4-bit tile type from individual bits stored in separate bit
     * sets.
     *
    ...
    public static TileTypeMap load() throws IOException, ClassNotFoundException {
        try (ObjectInputStream ois = new ObjectInputStream(Walker.class.getResourceAsStream("tile_type.dat")) {
            ...
            protected Class<?> resolveClass(ObjectStreamClass desc) throws IOException, ClassNotFoundException {
                ...
                if (name.equals("com.tonic.services.pathfinder.collision.SparseBitSet") ||
                        name.equals("ht.heist.services.pathfinder.collision.SparseBitSet")) {
                    return ht.heist.services.pathfinder.collision.SparseBitSet.class;
                }
                if (name.equals("[Lcom.tonic.services.pathfinder.collision.SparseBitSet;") ||
                        name.equals("[Lht.heist.services.pathfinder.collision.SparseBitSet;")) {
                    return ht.heist.services.pathfinder.collision.SparseBitSet[].class;
                }
