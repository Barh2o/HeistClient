package ht.heist.services.pathfinder.sailing.graph;
 ...
 * Edges: VarInt count + (source_packed:4, target_packed:4, tile_mask:2) per
 * edge
 */
public final class NavGraphLoader {
    ...
    public static NavGraph load(InputStream is) {
        ...
        try (DataInputStream dis = new DataInputStream(new BufferedInputStream(is))) {
            ...
            System.out
                    .println("NavGraphLoader: Loaded " + nodeSet.cardinality() + " nodes and " + edgeCount + " edges");
