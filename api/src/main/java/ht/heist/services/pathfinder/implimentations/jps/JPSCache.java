package ht.heist.services.pathfinder.implimentations.jps;
...
public class JPSCache
{
    ...
    private List<JPSStep> interpolatePath(int from, int to) {
        ...
        short x1 = ht.heist.util.WorldPointUtil.getCompressedX(from);
        short y1 = ht.heist.util.WorldPointUtil.getCompressedY(from);
        byte plane1 = ht.heist.util.WorldPointUtil.getCompressedPlane(from);

        short x2 = ht.heist.util.WorldPointUtil.getCompressedX(to);
        short y2 = ht.heist.util.WorldPointUtil.getCompressedY(to);
        byte plane2 = ht.heist.util.WorldPointUtil.getCompressedPlane(to);
        ...
        ht.heist.services.pathfinder.collision.CollisionMap collisionMap =
            ht.heist.services.pathfinder.Walker.getCollisionMap();
        ...
        while (currentX != x2 || currentY != y2) {
            ...
            int pos = ht.heist.util.WorldPointUtil.compress((short)currentX, (short)currentY, plane1);
