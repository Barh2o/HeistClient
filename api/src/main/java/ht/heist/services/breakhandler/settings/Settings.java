...
public class Settings
{
    ...
    static final String MAX_BETWEEN = "maxBetween";
    static final String MIN_DURATION = "minDuration";
    ...
    static final String DISABLE_HIGH_RISK = "world.disable.highRisk";
    static final String DISABLE_LMS = "world.disable.lms";
    static final String DISABLE_SKILL_TOTAL = "world.disable.skillTotal";
    static final String DISABLE_BOUNTY = "world.disable.bounty";

    static final String DISABLE_REGION_US = "world.disable.region.us";
