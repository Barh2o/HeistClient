package ht.heist.plugins.codeeval;
...
import ht.heist.plugins.codeeval.completion.*;
...
public class CodeEvalFrame extends VitaFrame {
    ...
    public CodeEvalFrame() {
        super("HeistClient Code Evaluator");
        ...
        contextToggle.setToolTipText("Toggle between API (HeistClient) and Client (obfuscated) classloader context");
    ...
    private void setupAutoCompletion() {
        ThreadPool.submit(() -> {
            try {
                ...
                // Initialize API context (HeistClient API classes)
